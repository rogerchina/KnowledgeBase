...
public class RESTfulTest {
	...
	public static void accessRESTfulServiceByRestEasy() {
		try {
			...
			FileInputStream fis = new FileInputStream(
					new File("C:\\Users\\roger.zhang\\Desktop\\coc.client.trustStore.jks"));
	...
	public static CloseableHttpClient createSSLClientDefault() {
		try {
			...
			SSLContext sslContext = new SSLContextBuilder().loadTrustMaterial(ks, new TrustStrategy() {
				// trust all
				@Override
	...
	public static void ssl() {
		...
		try {
			...
			// HttpPost http = new
			// HttpPost("https://localhost:8443/p4m/rest/chart-service/chart/single-number/hello");
			...
			// http.setHeader("User-Agent","Mozilla/4.0 (compatible; MSIE 5.0;
			// Windows NT; DigExt)");
			String username = "medavisadmin";
			String password = "PeterPan";
			String authorization = "Basic " + Base64.encodeBase64String((username + ":" + password).getBytes());
