...
public class TestMongodb {
	...
	public static void main(String[] args) {
		...
		MongoCursor<Document> cursor = MongoDBUtil.instance.find(coll, Filters.eq("name","zhoulf"));
		while(cursor.hasNext()) {
			org.bson.Document doc = (Document)cursor.next();
...
enum MongoDBUtil {
	...
	static {
		...
		builder.threadsAllowedToBlockForConnectionMultiplier(5000);// 线程队列数，如果连接线程排满了队列就会抛出“Out
																	// of
																	// semaphores
																	// to
																	// get
