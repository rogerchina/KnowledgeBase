...
public class ClassTest {
	...
	// clazz =
	// Class.forName("com.debuglife.codelabs.crazyit.chapter18.ClassTest");
	...
	System.out.println("带有一个字符串参数的info(...)方法是: "
	...
	// @SuppressWarnings's Retention(value=SOURCE), so the clazz at runtime
	// didn't access it.
	System.out.println("获取指定的Annotation:"
	...
	Class inClazz = Class
		.forName("com.debuglife.codelabs.crazyit.chapter18.ClassTest$Inner");
